...
namespace ConsoleUI
{
    ...
    {
        public static void CreateZombieHunterPlayer(ref Character player)
        {
            string input = "";
            ...
            do
            {
                ...
                switch (keyboard.Key)
                {
                    ...
                    case ConsoleKey.NumPad1:
                        ...
                        CreateNameAndPassword(ref player );
                        break;

                    case ConsoleKey.D2:
                    case ConsoleKey.NumPad2:
                        //Select player class
                        SelectPlayerClass(ref player,charLoop, keyboard);
                        break;
                    case ConsoleKey.D3:
                    case ConsoleKey.NumPad3:
                        //Select player race
                        SelectPlayerRace(ref player,charLoop, keyboard);
                        break;
                    case ConsoleKey.D4:
        ...
        public static void CreateNameAndPassword(ref Character player)
        {
        ...
        public static void SelectPlayerClass(ref Character player,bool characterLoop, ConsoleKeyInfo keyboard)
        {   //Select player class                    
            do
            {
        ...
        public static void SelectPlayerRace(ref Character player, bool characterLoop, ConsoleKeyInfo keyboard)
        {
            Console.Clear();
            //Select player race
            do
